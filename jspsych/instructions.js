...
const PERSONAL_CODE_CHOICE_HTML =`
    ...
    <input type="text" id="personal_code" name="personal_code"
        pattern="[a-zA-Z0-9]{1,8}" placeholder="k39d9" required><span class="validity"></span>
    <br>
    <br>
    </div>
    `
        ...
        <li> Blijf <strong>zelf achter uw kind</strong> staan of zitten en kijk naar beneden gedurende het onderzoek.</li>
            <div>
                <ul class="bullet-open">
                    ...
                    <li>Houd tijdens het experiment het handje van uw kind vast of leg uw hand op de schouder van uw kind, zodat uw kind weet dat u nog aanwezig bent zonder achterom te hoeven kijken.</li>
                </ul>
            </div>
    </ol>
`;
