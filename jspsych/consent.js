...
const CONSENT_STATEMENT = `
    <strong>Door dit hokje aan te vinken verklaart u voorgaande bepalingen te hebben gelezen en begrepen, en stemt 
...
let consent_block = {
    ...
    on_start: set_paragraph_text_to_small,
    preamble: CONSENT_HTML_STYLE_UU_SMALL_PARAGRAPH_TEXT + CONSENT_HTML,
    ...
    on_finish: function(data){
        ...
        //unsure if this call is needed
        set_paragraph_text_to_normal
    }
};
